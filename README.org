...
Build your own Swiss army command line Emacs toolkit and easily apply commands to either current file or dired files or you can [[Install my Swiss army command line toolkit][install mine]].
